...
\begin{figure}[] \centering
	...
	\caption{Medium coverage adsorption of HBBNC at RT on Ag(111). Additional binding motifs occur and are marked in green and white boxes. \textcolor{red}{Scalebar, Imaging parameter: \SI{11.07}{\nano \meter}, \SI{1.5}{\volt}, \SI{0.1}{\nano \ampere}}.}
	\label{}
\end{figure}
