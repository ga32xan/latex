...
%	\input{./includes/chapter/sem-technique}
	...
	\subsection{SEM characterization} One can see in \autoref{fig:SEM-gb} that the surface is imaged in different intensities. These are attributed to the different orientation of the copper grains within the foil\cite{wu_effects_2015}. The grain size ranges from just a few \SI{}{\micro \meter} to several hundred \SI{}{\micro \meter}. 
...
%	\end{figure}
	...
	\begin{figure}\centering
		\subfigure[Copper foil before etching.]{
			\includegraphics[width=0.4\textwidth]{./images/as_bought_zoomed_upper_half}
			\label{fig:foil-bought-afm}
		} \quad
		\subfigure[Copper foil after etching]{
			\includegraphics[width=0.4\textwidth]{./images/polished0000_zoomed_upper_half}
			\label{fig:foil-polished-afm}
		} \quad
		\subfigure[Height profiles of the two samples.]{
			\includegraphics[width=0.8\textwidth]{./images/as_bought-polished_0000-profiles}
