...
\end{figure}
	...
	For a \textbf{scaled and rotated over layer} the angle between substrate and moir\'e ($\gamma$[rad]) scales with the angle between over layer and substrate ($\alpha$[rad]) as $\alpha=(1-p)\gamma$.
...
%		} \quad
%		\subfigure[\textbf{STM image of \textit{h}-BN grown with CVD on Ir(111)} \cite{farwick_zum_hagen_structure_2016}]{
%			\includegraphics[width=0.25\textwidth]{./images/STM-hBN-Ir111-pub}%
...
\textcolor{red}{\textbf{What direction does the resulting surface dipole point at? Give an image?}}