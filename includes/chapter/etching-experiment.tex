...
\begin{figure}[] \centering
	\subfigure[(\SI{570}{\micro \meter} x \SI{380}{\micro \meter})]{ \includegraphics[width=0.45\textwidth]{./images/Domenik_16031715.jpg}
	\label{fig:SEM-1}
	
} \quad
	\subfigure[(\SI{18}{\micro \meter} x \SI{12}{\micro \meter})]{	\includegraphics[width=0.45\textwidth]{./images/Domenik_16031717.jpg}
	\label{fig:SEM-2}
}
