...
A separate piezo is used to control the lateral position of the tip during scanning. With it image width, scan speed and tip-sample distance can be controlled on a continuous, sub-atomic length scale.
