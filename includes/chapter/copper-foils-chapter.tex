...
\begin{figure}\centering
	\subfigure[\SI{570}{\micro \meter}$\times$\SI{380}{\micro \meter}]{\includegraphics[width=0.7\textwidth]{./images/Domenik_16031715}
		\label{fig:SEM-1}
	}
	\subfigure[\SI{18}{\micro \meter}$\times$\SI{12}{\micro \meter}]{\includegraphics[width=0.33\textwidth]{./images/Domenik_16031717}
		\label{fig:SEM-2}
	} \quad
	\subfigure[\SI{5.6}{\micro \meter}$\times$\SI{3.7}{\micro \meter}]{\includegraphics[width=0.33\textwidth]{./images/Domenik_16031700}
		\label{fig:SEM-3}
	}
