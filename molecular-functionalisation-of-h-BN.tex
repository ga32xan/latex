...
%
% Use MikTeX version 2.9.6615 or lated (check that biber is included)
...
\begin{document}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \input{./includes/pages/cover}										%					%
 \frontmatter{}			 											%					%
   \input{./includes/pages/titlepage}								%					%
   \input{./includes/pages/disclaimer}								% 					%
   \input{./includes/pages/acknowledgements}	% Titlepage and all the formal stuff	%
												%				 goes here!				%
   \input{./includes/pages/abstract}								%					%
...
\chapter{Experimental procedures}
  \section{\textbf{X}-ray \textbf{P}hotoelectron \textbf{S}pectroscopy}
     \input{./includes/chapter5/xps-technique}
