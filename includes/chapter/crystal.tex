...
Large grains are preferred for growing 2D materials on copper foils because grain boundaries are subject to inhomogeneities within the 2D layer and provide a route for unwanted surface chemistry (copper oxidation for example). 
%This effect can also be used to highlight grain boundaries as shown in \cite{wu_effects_2015}.
