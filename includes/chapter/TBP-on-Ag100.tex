...
\subfigure[]{  \includegraphics[width=0.45\textwidth]{./images/F150612-154558-10nm.png}
\label{fig:single-TBP-Ag100-cross-STM}
}
\subfigure[]{  \includegraphics[width=0.45\textwidth]{./images/F150612-154558-10nm-model2.png}
	\label{fig:single-TBP-Ag100-cross-model}
}
\caption{A cross consisting of four TBP molecules. \subref{fig:single-TBP-Ag100-cross-STM} STM data. Scan parameters: $U_b=\SI{2.3}{\volt}, I_t=\SI{0,035}{\nano \ampere}$, color scale \SIrange{0}{300}{\pico\meter} Image width: \SI{10}{\nm}. \subref{fig:single-TBP-Ag100-cross-model} Model representation in the same size.}
