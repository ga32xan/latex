...
\subsection{Theory}
\index{XPS!Physical model}As the X-rays hit and penetrate the sample surface they excite electrons at the surface and on the lower lying atomic energy level along their path.
