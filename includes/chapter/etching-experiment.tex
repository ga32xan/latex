...
\begin{figure}[] \centering
	\subfigure[]{		\includegraphics[width=0.45\textwidth]{./images/Domenik_16031715.jpg}
	\label{fig:SEM-1}
	
} \quad
	\subfigure[]{			\includegraphics[width=0.45\textwidth]{./images/Domenik_16031717.jpg}
	\label{fig:SEM-2}
}

	\caption{SEM image of etched copper foil. Different contrast suggests different grain-orientation within the surface. \subref{fig:SEM-1} Larger (\SI{570}{\micro \meter} x \SI{380}{\micro \meter}) image showing the contrast of different grains in the copper-foil, \subref{fig:SEM-2} zoom (\SI{18}{\micro \meter} x \SI{12}{\micro \meter})} to a area with two different contrasts and their border.
	\label{fig:SEM-gb}
\end{figure}
